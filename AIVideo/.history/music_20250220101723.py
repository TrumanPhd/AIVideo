...
from moviepy.config import change_settings # Correct import
# 修改函数开始
def add_music(video_path):
    ...
    try:
        # 重要：显式设置 FFmpeg 二进制文件路径
        change_settings({"FFMPEG_BINARY": "/opt/homebrew/bin/ffmpeg"})  # 替换为你系统上 ffmpeg 的实际路径！

...
# 初始化文本提示
initial_prompt = "用英文创作一个吸引人的5s短视频生成的文本提示要求尽量详细，在画面中间要有一个主角，主角要有夸张或者快速的动作，环境的部分要自然美观，视频提示文本部分不分段，用一个完整自然段输出，不少于400词，不超过600词，要求大开脑洞有天马行空的想象，画面要鲜艳脑洞吸引人，只打印用作视频生成模型的提示和视频的标题，用下面格式输出: 英文的视频题目||视频的文本提示  此外不要含有任何其他符号"

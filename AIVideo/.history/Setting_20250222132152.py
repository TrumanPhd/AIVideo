...
initial_prompt = 'Create a Captivating 5-Second Short Video: The text prompt for the video generation should be as detailed as possible. In the center of the frame, there must be a main character who performs exaggerated or rapid movements. The surrounding environment should be natural and aesthetically pleasing. The video prompt text should be a continuous paragraph of no less than 300 words and no more than 500 words. Think outside the box with fantastical imagination. The visuals should be vibrant and creatively captivating. Only the prompt for the video generation model and the video title are to be printed, using the following format: "Video Title in English"+||+"Video Prompt Text in English, output as a single, uninterrupted paragraph" '
# 模型s
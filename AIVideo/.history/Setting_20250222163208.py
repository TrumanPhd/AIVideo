...
# 初始化文本提示
initial_prompt = "创作一个吸引人的5s视频画面场景,在画面中间要有一个可爱小动物，要对它的外貌有详细的描写，他正在从事一些人类才能从事的特定的工作，穿着人类才能穿的特定的制服，视频提示文本部分不分段用一个完整自然段输出，不超过400词，要求大开脑洞有天马行空的想象，用下面格式输出: 英文标题+|||+画面文本提示不分段用一个完整的段落输出 "

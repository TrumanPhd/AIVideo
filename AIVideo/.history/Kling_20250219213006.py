...
# ---- 配置参数 ----
KLING_AI_API_ENDPOINT = "https://api.klingai.com/v1/videos/text2video"
...
def call_kling(api_key, secret_key, model_name="kling-v1", duration="5", text_prompt4video="A futuristic city", video_save_path=VIDEO_SAVE_PATH, max_retries = 3):
    """
